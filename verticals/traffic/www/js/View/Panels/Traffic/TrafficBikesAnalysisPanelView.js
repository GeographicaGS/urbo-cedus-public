...
App.View.Panels.Traffic.Analysis = App.View.Panels.Splitted.extend({
  ...
  customRender: function(){
    ...
    this._widgets.push(new App.View.Widgets.Traffic.OccupancyRatePerHour({
      id_scope: this.scopeModel.get('id'),
    }));

    this._widgets.push(new App.View.Widgets.Traffic.FreeOccupancyRateEvolution({
      id_scope: this.scopeModel.get('id'),
    }));

    this._widgets.push(new App.View.Widgets.Traffic.HourlyBikesAvailability({
      id_scope: this.scopeModel.get('id'),
    }));
  ...
  onAttachToDOM: function(){
    this._mapView = new App.View.Map.Traffic.Evolution({
