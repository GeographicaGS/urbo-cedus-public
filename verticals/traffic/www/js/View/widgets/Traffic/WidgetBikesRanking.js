...
App.View.Widgets.Traffic.BikesRanking = App.View.Widgets.Base.extend({

  initialize: function(options) {
    options = _.defaults(options,{
      title: __('Ranking de población servida por estación'),
      timeMode:'now',
      id_category: 'watmeter_a'
    });
    ...
    var tableModel = new Backbone.Model({
      css_class: 'transparent rankingWidget traffic',
      csv:false,
      columns_format:{
        name: {
