...
const additionalTrafficInfoCatalog = {
  'traffic': { colour: '#4069b2', icon: '../verticals/traffic/img/menuPanel/SC_ic_vertical_movilidad_M.svg' },
  'traffic.trafficflowobserved': { colour: '#33cc66', icon: '../verticals/traffic/img/SC_icmap_viamonitor_sproblema.png' }
}
App.Metadata.prototype._additionalInfoCatalog = Object.assign(App.Metadata.prototype._additionalInfoCatalog, additionalTrafficInfoCatalog);
