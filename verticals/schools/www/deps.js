...
var src = 'src/verticals/schools/';
var srcJS = src + 'js/';
var public = 'verticals/schools/';
...
deps.JS = [
  srcJS + 'Namespace.js',
  srcJS + 'Metadata.js',
  srcJS + 'Collection/Schools.js',
  srcJS + 'View/Filter/Schools/PoiFilter.js',  
  srcJS + 'View/Map/Schools/CurrentMapView.js',
  srcJS + 'View/Map/Schools/Layer/SchoolLayer.js',
  srcJS + 'View/Panels/Schools/SchoolsMasterPanelView.js',
  srcJS + 'View/Panels/Schools/SchoolsCurrentPanelView.js',
  srcJS + 'View/widgets/Schools/SchoolsSummaryValues.js',
  srcJS + 'View/widgets/Schools/InternshipStatusStacked.js',
  srcJS + 'View/widgets/Schools/WidgetCounterSimple.js',
  srcJS + 'View/widgets/Schools/InternshipsTable.js',
  srcJS + 'View/widgets/Schools/CoursesTable.js',
  srcJS + 'View/widgets/Schools/KPITable.js',
];
